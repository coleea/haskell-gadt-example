...
/* package haskell-gadt-example-0.1.0.0 */
#ifndef VERSION_haskell_gadt_example
#define VERSION_haskell_gadt_example "0.1.0.0"
#endif /* VERSION_haskell_gadt_example */
#ifndef MIN_VERSION_haskell_gadt_example
#define MIN_VERSION_haskell_gadt_example(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_gadt_example */
...
#define CURRENT_COMPONENT_ID "haskell-gadt-example-0.1.0.0-inplace-haskell-gadt-example"
